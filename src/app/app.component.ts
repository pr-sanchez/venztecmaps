...
export class AppComponent implements OnInit{
  ...
  constructor(private afAuth: AngularFireAuth, private db: AngularFireDatabase, private router:Router, private fb: FormBuilder, private auth: AuthService, private global: GlobalService) {
